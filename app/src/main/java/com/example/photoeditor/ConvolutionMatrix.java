            ...
            while (i3 < width - 2) {
                ...
                while (i6 < i) {
                    ...
                    while (i13 < i) {
                        ...
                        double d2 = convolutionMatrix2.Matrix[i6][i13];
                        Double.isNaN(red);
                        Double.isNaN(d);
                        i12 = (int) (d + (red * d2));
                        double d3 = (double) i11;
                        double green = (double) Color.green(iArr2[i6][i13]);
                        double d4 = convolutionMatrix2.Matrix[i6][i13];
                        Double.isNaN(green);
                        Double.isNaN(d3);
                        i11 = (int) (d3 + (green * d4));
                        double d5 = (double) i10;
                        double blue = (double) Color.blue(iArr2[i6][i13]);
                        double d6 = convolutionMatrix2.Matrix[i6][i13];
                        Double.isNaN(blue);
                        Double.isNaN(d5);
                        i10 = (int) (d5 + (blue * d6));
                        i13++;
                ...
                int i15 = i2;
                double d7 = (double) i7;
                double d8 = convolutionMatrix2.Factor;
                Double.isNaN(d7);
                int i16 = (int) ((d7 / d8) + convolutionMatrix2.Offset);
                if (i16 < 0) {
                    i16 = 0;
                } else if (i16 > 255) {
                    i16 = 255;
                ...
                Double.isNaN(d9);
                int i17 = (int) ((d9 / d10) + convolutionMatrix2.Offset);
                if (i17 < 0) {
                    i17 = 0;
                } else if (i17 > 255) {
                    i17 = 255;
                ...
                double d12 = convolutionMatrix2.Factor;
                Double.isNaN(d11);
                int i18 = (int) ((d11 / d12) + convolutionMatrix2.Offset);
                if (i18 < 0) {
                    i18 = 0;
                } else if (i18 > 255) {
                    i18 = 255;
